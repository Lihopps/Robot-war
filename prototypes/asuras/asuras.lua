require("prototypes/asuras/satellite-asteroids")
local asuras_asteroids=require("prototypes/asuras/asteroids-definition")
local planet_map_gen = require("prototypes/asuras/asuras-map-gen")
...
data.extend({
  ...
  },
  {
    ...
    type = "planet",
    name = "asuras",
    icon = "__Robot-war__/graphics/icons/asuras.png",
    starmap_icon = "__Robot-war__/graphics/icons/starmap-asuras-planet.png",
    ...
    order = "e[aquilo]-a",
    subgroup = "planets",
    map_gen_settings = planet_map_gen.asuras(),
    ...
    surface_properties =
    {
      ...
      ["solar-power"] = 15,
      pressure = 1500,
      gravity =0.5*15,-- rc/100*pression
      spidertron_buildability = 0,
      --robot comsuption = 100*gravity/(pression)
    },
    asteroid_spawn_influence = 0.01,
    asteroid_spawn_definitions = asuras_asteroids,
